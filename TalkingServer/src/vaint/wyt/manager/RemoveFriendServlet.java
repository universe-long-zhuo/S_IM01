...
public class RemoveFriendServlet extends HttpServlet {
	private static final long serialVersionUID = 2594374447616426381L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String userId = reqJson
				.optString(Constants.RemoveFriend.RequestParams.USER_ID);
		String friendId = reqJson
				.optString(Constants.RemoveFriend.RequestParams.FRIEND_ID);
		// 参数缺失
		...
		boolean bRet = FriendsUtils.RemoveFriend(userId, friendId);
		if(bRet)
		{
			respJson.element(Constants.ResponseParams.RES_CODE,
		...
		{
			respJson.element(Constants.ResponseParams.RES_CODE,
					Constants.RemoveFriend.ErrorInfo.CODE_REMOVE_FAILED);
			respJson.element(Constants.ResponseParams.RES_MSG,
					Constants.RemoveFriend.ErrorInfo.MSG_REMOVE_FAILED);
		}
